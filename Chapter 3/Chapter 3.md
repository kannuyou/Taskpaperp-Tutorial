...
[@Hum](https://sspai.com/user/681230/updates) 在[《用更现代的方式做任务管理》](https://sspai.com/series/1/list)一书中，详细讲解了他如何用 `@EasyDo` 标签标出精神低迷时可以做的事情；自由撰稿人 [@赵赛坡](https://dailyio.me/) 更是把时间管理的理念称之为「精力管理」。

在这里，我也简单列出自己使用过的精力标签，你可以选出自己典型的「峰期」和「谷期」，往里面充填一些适合的任务，达到更好的工作状态。
